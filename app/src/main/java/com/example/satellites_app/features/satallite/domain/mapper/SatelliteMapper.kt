...
fun SatelliteListEntity.toSatelliteDetail() = SatellitesModel(
    id = satelliteId,
    active = active,
    name = name
)

fun SatelliteDetailEntity.toSatelliteDetail() = SatelliteDetailModel(
    id = satelliteId,
...
fun SatellitePositionEntity.toSatellitePositions(): SatellitePositionsModel {
